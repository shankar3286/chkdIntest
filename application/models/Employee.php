...
class Employee extends CI_Model
{
    ...
    var $select_column = array("id", "full_name", "phone_number", "email","company","designation");  
    var $order_column = array(null, "full_name", "phone_number", "email","company","designation");  
    function make_query()  
    {  
